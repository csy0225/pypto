...
class FullRopeL3RealProducers:
    ...
    def host_orch(
        ...
        input_rms_weight: pl.Tensor[[1, 1, HIDDEN], pl.FP32],
        wq: pl.Tensor[[1, HIDDEN, HIDDEN_Q], pl.BF16],
        wk: pl.Tensor[[1, HIDDEN, KV_HIDDEN], pl.BF16],
        wv: pl.Tensor[[1, HIDDEN, KV_HIDDEN], pl.BF16],
        q_norm_weight: pl.Tensor[[1, 1, HEAD_DIM], pl.FP32],
        k_norm_weight: pl.Tensor[[1, 1, HEAD_DIM], pl.FP32],
        ...
        self.chip_orch(
            ...
            pl.tensor.slice(input_rms_weight, [1, 1, HIDDEN], [0, 0, 0], [], [0]),
            ...
            pl.tensor.slice(q_norm_weight, [1, 1, HEAD_DIM], [0, 0, 0], [], [0]),
            pl.tensor.slice(k_norm_weight, [1, 1, HEAD_DIM], [0, 0, 0], [], [0]),
...
def main():
    ...
    tensors = {
        ...
        'input_rms_weight': torch.ones(1, 1, HIDDEN, dtype=torch.float32),
        ...
        'q_norm_weight': torch.ones(1, 1, HEAD_DIM, dtype=torch.float32),
        'k_norm_weight': torch.ones(1, 1, HEAD_DIM, dtype=torch.float32),
    ...
    compiled(
        ...
        tensors['rope_cos'], tensors['rope_sin'], tensors['k_cache'], tensors['v_cache'], tensors['all_q_padded'], torch.tensor(0, dtype=torch.int32),
    )
    print('PASS')
