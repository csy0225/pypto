...
class FullRopeTrueCacheId6:
    ...
    def host_orch(
        ...
        seq_lens: pl.Tensor[[1, USER_BATCH_DYN], pl.INT32],
        slot_mapping: pl.Tensor[[1, USER_BATCH_DYN], pl.INT32],
        ...
        self.chip_orch(
            ...
            pl.tensor.slice(seq_lens, [1, USER_BATCH_DYN], [0, 0], [], [0]),
            pl.tensor.slice(slot_mapping, [1, USER_BATCH_DYN], [0, 0], [], [0]),
...
def main():
    work_dir = Path('/tmp/p15_min_rope_dyn_user_batch')
    if work_dir.exists():
