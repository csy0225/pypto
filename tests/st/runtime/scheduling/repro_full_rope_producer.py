...
def main():
    ...
    parser.add_argument('--out', default='/tmp/p15_min_full_rope_producer')
    ...
    compile_program(FullRopeProducerMin, work_dir, strategy=OptimizationStrategy.Default, backend_type=BackendType.Ascend910B)
    specs = [
